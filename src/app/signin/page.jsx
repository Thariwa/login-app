...
export default function Page() {
  ...
  return (
    ...
    <div className='bg-gradient-to-r from-slate-800 to-rose-500 min-h-screen'>
      ...
      <p><input type='radio' name='Remember me' className='mt-4 text-red-600'/>
      <label htmlFor="remember me">Remember me</label></p>
   
      <button className='text-center bg-blue-900 text-white px-20 py-0 border rounded-md mt-4 '>Sign In</button>
